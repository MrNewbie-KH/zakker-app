...
async function showNotesFromDataBase(){
  let notesOnline=[]
  const headers = { 'Authorization': 'Token cd35c838ea064d28f7c698af8f5acc341f8cde297dc3d05054999d67ab5d23ca' }; // auth header with bearer token
...
async function addNotesToDataBase(){
  ...
  await fetch("http://127.0.0.1:8000/notes/", {
    ...
    headers: {
      ...
      "Authorization": "Token cd35c838ea064d28f7c698af8f5acc341f8cde297dc3d05054999d67ab5d23ca"
    }
  });
  showNotes();
  closeIcon.click();
